...
-- 반려동물
       ...
       (1, FALSE, FALSE, 8, NOW(), 5, NOW(), '캣 카페 집사', '고양이 카페를 함께 방문하는 모임입니다.', 5)
        ,
       (1, FALSE, FALSE, 8, NOW(), 5, NOW(), '딩동댕 유치원🐾', '천사같은 내새꾸랑 행복한 추억쌓기😄', 5)
        ,
       (1, FALSE, FALSE, 8, NOW(), 5, NOW(), '냥아치🐈‍⬛', '❤️소수정예 ❗️고양이 집사들의 모임.', 5)
        ,
       (1, FALSE, FALSE, 8, NOW(), 5, NOW(), '퍼스티니', '반려동물 봉사단체.', 5)
        ,
       (1, FALSE, FALSE, 8, NOW(), 5, NOW(), '온리독', '유기동물 봉사 모임.', 4)
        ,
